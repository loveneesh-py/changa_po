...
from helper import diceRoll, move, checkEnemy, possibleMoves, board_overview, adjustDisplay, gameDone
...
#---------------------------------------------------------------------------------------------------
# Caption & icon
pygame.display.set_caption("Changa Po")
...
game_name=pygame.image.load("assets/icons/logo.jpg")
		...
		for j in range(WIDTH):
			...
			if(i!=0 and i!=HEIGHT-1 and j!=0 and j!=WIDTH-1):
				if((i,j) in safe_places):
					pygame.draw.rect(screen, (166, 166, 166), rect)
